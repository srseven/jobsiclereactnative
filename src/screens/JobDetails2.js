...
export default class JobDetails2 extends Component {
  render() {
    return (
        ...
        <View style={styles.stickyBar}>
          ...
          <View style={styles.stickyBarRight}>
            <View style={{ alignSelf: "center", flexDirection: "row", alignItems: "center" }}>
              ...
              <Image resizeMode="contain" style={{ width: 10, height: 10, marginHorizontal: 5 }} source={require('../resources/icons/notsaved_small.png')} />
            </View>
          </View>
        </View>
      </Container >
